...
class FAQsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        englishArr = ["Who does CTC provide care for?".localized, "Individuals of all ages facing homelessness.", "Is CTC a “free clinic”?".localized, "No. CTC is a federally qualified community health center (FQHC) and will bill patients’ insurances for services provided. Many individuals facing homelessness are insured by AHCCCS, the state’s Medicaid system.".localized, "What if a person is uninsured?".localized, "Most individuals facing homelessness that are not insured qualify for the CTC sliding fee discount scale. Those patients may receive their care at no cost or for a small fee depending on income.".localized, "What happens if a person who is not homeless seeks care from CTC?".localized, "If the patient is seeking acute care, the medical need will be addressed and the patient will be assisted in establishing care at another health center. If the patient intends to establish care or is seeking preventative care, the patient will be assisted in making a future appointment with another health center.".localized, "What other services can I receive at CTC?".localized, "Circle the City offers integrated health care services that include behavioral health, additionally our clinics also have patient navigation services to assist patients in coordinating their care, connection to resources, and much more.".localized, "Have you been to the hospital recently?".localized, "If you were recently discharge from a hospital please bring in your records or notify the clinic you were recently discharge and provide the hospital information. By providing this information to us, we can begin to obtain hospital records and have them available prior to your visit.".localized, "Do I need to schedule an appointment to receive care in one of CTC’s Mobile Medical Care Units?".localized, "No. Our Mobile Medical Care Units operate on a walk-in basis, an appointment is never required.".localized, "Are you concerned about transportation?".localized, "Good news, transportation services are covered through AHCCCS. Contact your health plan 72 hours in advance to arrange a ride. If you do not qualify for transportation, please contact us and will make every attempt to make accommodations if possible.".localized, "What if I don’t speak English?".localized, "Many of our staff members are bilingual in Spanish and if you speak another language, we have interpretation services available through a third party.".localized]
